Page({
  ...
  onLoad() {
    const fileID = 'cloud://cloud1-4g4nzi8a994f009b.636c-cloud1-4g4nzi8a994f009b-1411647226/maps/handmap.png';
    this.setData({
      handmapUrl: fileID,
      activeSpot: this.data.spots[0]
    });
  },
  onSelectSpot(e) {
  ...
  onShare() {
    wx.showToast({
      title: `分享打卡点: ${this.data.activeSpot.title}`,
      icon: 'none'
    });
  }
});
